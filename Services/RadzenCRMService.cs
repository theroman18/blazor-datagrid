...
namespace CRMBlazorServerRBS
{
    public partial class RadzenCRMService
    {
        ...
        partial void OnGetContactById(ref IQueryable<CRMBlazorServerRBS.Models.RadzenCRM.Contact> items);
        ...
        partial void OnGetOpportunityById(ref IQueryable<CRMBlazorServerRBS.Models.RadzenCRM.Opportunity> items);
        ...
        partial void OnGetOpportunityStatusById(ref IQueryable<CRMBlazorServerRBS.Models.RadzenCRM.OpportunityStatus> items);
        ...
        partial void OnGetTaskById(ref IQueryable<CRMBlazorServerRBS.Models.RadzenCRM.Task> items);
        ...
        partial void OnGetTaskStatusById(ref IQueryable<CRMBlazorServerRBS.Models.RadzenCRM.TaskStatus> items);
        ...
        partial void OnGetTaskTypeById(ref IQueryable<CRMBlazorServerRBS.Models.RadzenCRM.TaskType> items);
