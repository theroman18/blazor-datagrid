...
namespace CRMBlazorServerRBS.Components.Pages
{
    public partial class OpportunityStatuses
    {
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = isEdit ? await RadzenCRMService.UpdateOpportunityStatus(opportunityStatus.Id, opportunityStatus) : await RadzenCRMService.CreateOpportunityStatus(opportunityStatus);
